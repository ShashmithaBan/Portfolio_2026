            ...
            <div className="mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
                ...
                <nav className="hidden lg:flex justify-center absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <div className="flex items-center gap-2 md:gap-3 px-4 md:px-5 py-2 md:py-2 rounded-full bg-[#1A0C00]/10 backdrop-blur-sm border border-gray-700/50">
                        {['home','about', 'skills', 'experience', 'connect'].map((item) => (
                            <a
                                key={item}
                                href={`#${item}`}
            ...
            {mobileMenuOpen && (
                <div className="lg:hidden bg-gray-900/95 backdrop-blur-sm border-t border-white/10 animate-in fade-in duration-300">
                    <nav className="flex flex-col gap-4 px-6 py-6">
                        <a href="#home" className="text-white hover:text-purple-600 hover:translate-x-2 transition-all duration-300 text-base font-poppins font-medium transform">Home</a>
                        <a href="#skills" className="text-white hover:text-purple-600 hover:translate-x-2 transition-all duration-300 text-base font-poppins font-medium transform">Skills</a>
                        <a href="#experience" className="text-white hover:text-purple-600 hover:translate-x-2 transition-all duration-300 text-base font-poppins font-medium transform">Experience</a>
                        <a href="#contact" className="text-white hover:text-purple-600 hover:translate-x-2 transition-all duration-300 text-base font-poppins font-medium transform">Connect</a>
