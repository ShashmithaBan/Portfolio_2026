    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#1A0C00]/40 backdrop-blur-md border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center gap-2 z-10">
          <button className="flex items-center gap-2 px-4 py-2 border border-gray-400 text-white rounded-full bg-gray-800/50 backdrop-blur-sm hover:bg-gray-700/50 transition-colors duration-200 text-sm">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-gray-900/95 backdrop-blur-sm border-t border-white/10">
          <nav className="flex flex-col gap-4 px-6 py-6">
            <a href="#home" className="text-white hover:text-orange-400 transition text-lg">Home</a>
            <a href="#skills" className="text-white hover:text-orange-400 transition text-lg">Skills</a>
            <a href="#experience" className="text-white hover:text-orange-400 transition text-lg">Experience</a>
            <a href="#contact" className="text-white hover:text-orange-400 transition text-lg">Connect</a>
            <button className="mt-4 px-6 py-3 bg-orange-600 hover:bg-orange-700 rounded-full transition font-semibold text-sm text-white">
              Download Resume
            </button>
          </nav>
        </div>
